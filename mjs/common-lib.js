...
Object.defineProperties(_wcl, {
  ...
  loadScript: {
    ...
    value: function () {
      ...
      Array.from(arguments).forEach(path => {
  ...
  isPrefersColorSchemeSet: {
    ...
    get: () => {
      return Array.from(document.styleSheets).some(styleSheet => {
        try {
          return Array.from(styleSheet.rules).some(rule => {
  ...
  pointer: {
    ...
    value: function (e) {
      ...
      x =
        e.pageX ||
        e.clientX + (docElement.scrollLeft || body.scrollLeft) - (docElement.clientLeft || 0);

      //y
      body = document.body || {scrollTop: 0};
      y =
        e.pageY ||
        e.clientY + (docElement.scrollTop || body.scrollTop) - (docElement.clientTop || 0);
  ...
  isPiPSupport: {
    ...
    value: function () {
      ...
      if (typeof navigator.supports.PiP === 'undefined') {
        ...
        navigator.supports.PiP =
          this.isAPISupport('requestPictureInPicture', node) ||
          (node.webkitSupportsPresentationMode &&
            typeof node.webkitSetPresentationMode === 'function');
      }
